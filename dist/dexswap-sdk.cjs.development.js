...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.MAINNET] = _contracts_json.mainnet.factory, _FACTORY_ADDRESS[exports.ChainId.RINKEBY] = _contracts_json.rinkeby.factory, _FACTORY_ADDRESS[exports.ChainId.HARMONY] = _contracts_json.harmony.factory, _FACTORY_ADDRESS[exports.ChainId.HARMONY_TESTNET] = _contracts_json.harmony_testnet.factory, _FACTORY_ADDRESS);
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[exports.ChainId.MAINNET] = _contracts_json$1.mainnet.router, _ROUTER_ADDRESS[exports.ChainId.RINKEBY] = _contracts_json$1.rinkeby.router, _ROUTER_ADDRESS[exports.ChainId.HARMONY] = _contracts_json$1.harmony.router, _ROUTER_ADDRESS[exports.ChainId.HARMONY_TESTNET] = _contracts_json$1.harmony_testnet.router, _ROUTER_ADDRESS);
var STAKING_REWARDS_FACTORY_ADDRESS = (_STAKING_REWARDS_FACT = {}, _STAKING_REWARDS_FACT[exports.ChainId.MAINNET] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT[exports.ChainId.RINKEBY] = '0x709db16a6ef437197938256460c49183dc36ca4d', _STAKING_REWARDS_FACT[exports.ChainId.HARMONY] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT[exports.ChainId.HARMONY_TESTNET] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT);
var INIT_CODE_HASH = '0x150b4ac6b908c76f4d28c378f9d050600e012455d0383ed35598e31688ee2e7b';
var MINIMUM_LIQUIDITY = /*#__PURE__*/JSBI.BigInt(1000); // exports for internal consumption

var ZERO = /*#__PURE__*/JSBI.BigInt(0);
var ONES = /*#__PURE__*/JSBI.BigInt(1);
...
function sqrt(y) {
  ...
  if (JSBI.greaterThan(y, THREE)) {
    z = y;
    x = JSBI.add(JSBI.divide(y, TWO), ONES);
...
Currency.NATIVE_CURRENCY = (_Currency$NATIVE_CURR = {}, _Currency$NATIVE_CURR[exports.ChainId.MAINNET] = Currency.ETHER, _Currency$NATIVE_CURR[exports.ChainId.RINKEBY] = Currency.ETHER, _Currency$NATIVE_CURR[exports.ChainId.HARMONY] = Currency.ONE, _Currency$NATIVE_CURR[exports.ChainId.HARMONY_TESTNET] = Currency.ONE, _Currency$NATIVE_CURR);
var USD = Currency.USD;
var ETHER = Currency.ETHER;
var ONE = Currency.ONE;
...
Token.NATIVE_CURRENCY_WRAPPER = (_Token$NATIVE_CURRENC = {}, _Token$NATIVE_CURRENC[exports.ChainId.MAINNET] = Token.WETH[exports.ChainId.MAINNET], _Token$NATIVE_CURRENC[exports.ChainId.RINKEBY] = Token.WETH[exports.ChainId.RINKEBY], _Token$NATIVE_CURRENC[exports.ChainId.HARMONY] = Token.WONE[exports.ChainId.HARMONY], _Token$NATIVE_CURRENC[exports.ChainId.HARMONY_TESTNET] = Token.WONE[exports.ChainId.HARMONY_TESTNET], _Token$NATIVE_CURRENC);
/**
...
var SWOOP_FACTORY_ADDRESS = '0x8F7F3708CF68759E2FEC78746545882039B1F31f';
var SWOOP_FACTORY_TESTNET = '0x3A3289aF62600bd7FF0811B546964F8C6a63dC72 '; // viperLP TESTNET:: 0x16d34ea43d76fb55b613748f15cfbe011b36227a
...
var SWOOP_ROUTER_ADDRESS = '0x0a91275aC54680E4ffAdB942d4E450AfECBA129f';
var SWOOP_ROUTER_ADDRESS_TESTNET = '0x78CE7F8691A3f9be2E953c7AE5ba48B8E36B5bb5 ';
...
RoutablePlatform.SWOOP = /*#__PURE__*/new RoutablePlatform('Swoop', (_RoutablePlatform7 = {}, _RoutablePlatform7[exports.ChainId.HARMONY] = SWOOP_FACTORY_ADDRESS, _RoutablePlatform7[exports.ChainId.HARMONY_TESTNET] = SWOOP_FACTORY_TESTNET, _RoutablePlatform7), (_RoutablePlatform8 = {}, _RoutablePlatform8[exports.ChainId.HARMONY] = SWOOP_ROUTER_ADDRESS, _RoutablePlatform8[exports.ChainId.HARMONY_TESTNET] = SWOOP_ROUTER_ADDRESS_TESTNET, _RoutablePlatform8), '0xe3c4d7c2f0f0eb6af0a666a9b54ea1196dd3676e4e4b696af853d8951f807cc5', _30);

var _INITIAL_CACHE_STATE, _PAIR_ADDRESS_CACHE;
var INITIAL_CACHE_STATE = (_INITIAL_CACHE_STATE = {}, _INITIAL_CACHE_STATE[exports.ChainId.MAINNET] = {}, _INITIAL_CACHE_STATE[exports.ChainId.HARMONY] = {}, _INITIAL_CACHE_STATE[exports.ChainId.HARMONY_TESTNET] = {}, _INITIAL_CACHE_STATE[exports.ChainId.RINKEBY] = {}, _INITIAL_CACHE_STATE);
var PAIR_ADDRESS_CACHE = (_PAIR_ADDRESS_CACHE = {}, _PAIR_ADDRESS_CACHE[RoutablePlatform.DEXSWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.SUSHISWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.UNISWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.VIPERSWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.SWOOP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE);
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    var inputAmount = new TokenAmount(outputAmount.token.equals(this.token0) ? this.token1 : this.token0, JSBI.add(JSBI.divide(numerator, denominator), ONES));
...
var Trade = /*#__PURE__*/function () {
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_OUTPUT) {
      ...
      var slippageAdjustedAmountOut = new Fraction(ONES).add(slippageTolerance).invert().multiply(this.outputAmount.raw).quotient;
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_INPUT) {
      ...
      var slippageAdjustedAmountIn = new Fraction(ONES).add(slippageTolerance).multiply(this.inputAmount.raw).quotient;
