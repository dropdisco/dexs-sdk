...
var STAKING_REWARDS_FACTORY_ADDRESS = (_STAKING_REWARDS_FACT = {}, _STAKING_REWARDS_FACT[ChainId.MAINNET] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT[ChainId.RINKEBY] = '0x709db16a6ef437197938256460c49183dc36ca4d', _STAKING_REWARDS_FACT[ChainId.HARMONY] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT[ChainId.HARMONY_TESTNET] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT);
...
Currency.NATIVE_CURRENCY = (_Currency$NATIVE_CURR = {}, _Currency$NATIVE_CURR[ChainId.MAINNET] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.RINKEBY] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.HARMONY] = Currency.ONE, _Currency$NATIVE_CURR[ChainId.HARMONY_TESTNET] = Currency.ONE, _Currency$NATIVE_CURR);
...
Token.NATIVE_CURRENCY_WRAPPER = (_Token$NATIVE_CURRENC = {}, _Token$NATIVE_CURRENC[ChainId.MAINNET] = Token.WETH[ChainId.MAINNET], _Token$NATIVE_CURRENC[ChainId.RINKEBY] = Token.WETH[ChainId.RINKEBY], _Token$NATIVE_CURRENC[ChainId.HARMONY] = Token.WONE[ChainId.HARMONY], _Token$NATIVE_CURRENC[ChainId.HARMONY_TESTNET] = Token.WONE[ChainId.HARMONY_TESTNET], _Token$NATIVE_CURRENC);
/**
...
RoutablePlatform.SWOOP = /*#__PURE__*/new RoutablePlatform('Swoop', (_RoutablePlatform7 = {}, _RoutablePlatform7[ChainId.HARMONY] = SWOOP_FACTORY_ADDRESS, _RoutablePlatform7[ChainId.HARMONY_TESTNET] = SWOOP_FACTORY_TESTNET, _RoutablePlatform7), (_RoutablePlatform8 = {}, _RoutablePlatform8[ChainId.HARMONY] = SWOOP_ROUTER_ADDRESS, _RoutablePlatform8[ChainId.HARMONY_TESTNET] = SWOOP_ROUTER_ADDRESS_TESTNET, _RoutablePlatform8), '0xe3c4d7c2f0f0eb6af0a666a9b54ea1196dd3676e4e4b696af853d8951f807cc5', _30);
