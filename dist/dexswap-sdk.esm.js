...
import { mainnet, rinkeby, harmony, harmony_testnet, mumbai } from 'dexswap-core/.contracts.json';
import { mainnet as mainnet$1, rinkeby as rinkeby$1, harmony as harmony$1, harmony_testnet as harmony_testnet$1, mumbai as mumbai$1 } from 'dexswap-periphery/.contracts.json';
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = mainnet.factory, _FACTORY_ADDRESS[ChainId.RINKEBY] = rinkeby.factory, _FACTORY_ADDRESS[ChainId.HARMONY] = harmony.factory, _FACTORY_ADDRESS[ChainId.HARMONY_TESTNET] = harmony_testnet.factory, _FACTORY_ADDRESS[ChainId.MUMBAI] = mumbai.factory, _FACTORY_ADDRESS);
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[ChainId.MAINNET] = mainnet$1.router, _ROUTER_ADDRESS[ChainId.RINKEBY] = rinkeby$1.router, _ROUTER_ADDRESS[ChainId.HARMONY] = harmony$1.router, _ROUTER_ADDRESS[ChainId.HARMONY_TESTNET] = harmony_testnet$1.router, _ROUTER_ADDRESS[ChainId.MUMBAI] = mumbai$1.router, _ROUTER_ADDRESS);
var STAKING_REWARDS_FACTORY_ADDRESS = (_STAKING_REWARDS_FACT = {}, _STAKING_REWARDS_FACT[ChainId.MAINNET] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT[ChainId.RINKEBY] = '0x709db16a6ef437197938256460c49183dc36ca4d', _STAKING_REWARDS_FACT[ChainId.HARMONY] = '0x3b2Cc22b41ed373a2E512E49D049d0E61ED226f8', _STAKING_REWARDS_FACT[ChainId.HARMONY_TESTNET] = '0x9072E625EB73A42F0FeFF5278Ed132c14B00D0cD', _STAKING_REWARDS_FACT[ChainId.MUMBAI] = '0x377DA5b8287e0360e53B7F4589c8dCB531c7936B', _STAKING_REWARDS_FACT);
...
Currency.NATIVE_CURRENCY = (_Currency$NATIVE_CURR = {}, _Currency$NATIVE_CURR[ChainId.MAINNET] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.RINKEBY] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.HARMONY] = Currency.HARMONY, _Currency$NATIVE_CURR[ChainId.HARMONY_TESTNET] = Currency.HARMONY, _Currency$NATIVE_CURR[ChainId.MUMBAI] = Currency.MATIC, _Currency$NATIVE_CURR);
var USD = Currency.USD;
var ETHER = Currency.ETHER;
var HARMONY = Currency.HARMONY;
var MATIC = Currency.MATIC;

var _Token$WETH, _Token$USDC, _Token$USDT, _Token$DAI, _Token$ZDEX, _Token$ZOO, _Token$DEZU, _Token$WONE, _Token$WMATIC, _Token$NATIVE_CURRENC;
/**
...
Token.NATIVE_CURRENCY_WRAPPER = (_Token$NATIVE_CURRENC = {}, _Token$NATIVE_CURRENC[ChainId.MAINNET] = Token.WETH[ChainId.MAINNET], _Token$NATIVE_CURRENC[ChainId.RINKEBY] = Token.WETH[ChainId.RINKEBY], _Token$NATIVE_CURRENC[ChainId.HARMONY] = Token.WONE[ChainId.HARMONY], _Token$NATIVE_CURRENC[ChainId.HARMONY_TESTNET] = Token.WETH[ChainId.HARMONY_TESTNET], _Token$NATIVE_CURRENC[ChainId.MUMBAI] = Token.WMATIC[ChainId.MUMBAI], _Token$NATIVE_CURRENC);
/**
...
var INITIAL_CACHE_STATE = (_INITIAL_CACHE_STATE = {}, _INITIAL_CACHE_STATE[ChainId.MAINNET] = {}, _INITIAL_CACHE_STATE[ChainId.HARMONY] = {}, _INITIAL_CACHE_STATE[ChainId.HARMONY_TESTNET] = {}, _INITIAL_CACHE_STATE[ChainId.RINKEBY] = {}, _INITIAL_CACHE_STATE[ChainId.MUMBAI] = {}, _INITIAL_CACHE_STATE);
